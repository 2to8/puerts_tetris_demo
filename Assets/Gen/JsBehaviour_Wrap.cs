...
namespace PuertsStaticWrap
{
    public static class JsBehaviour_Wrap
    {
        ...
        private static void G_ModuleName(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as JsBehaviour;
                var result = obj.ModuleName;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_ModuleName(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as JsBehaviour;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.ModuleName = argHelper.GetString(false);
            }
            catch (Exception e)
            {
                Puerts.PuertsDLL.ThrowException(isolate, "c# exception:" + e.Message + ",stack:" + e.StackTrace);
