...
{
    public static class UnityEngine_Events_UnityEvent_Wrap
    {
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var result = new UnityEngine.Events.UnityEvent();
                        
                        
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.Events.UnityEvent), result);
                    }
                }
        ...
        private static void M_AddListener(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.Events.UnityEvent;
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var Arg0 = argHelper0.Get<UnityEngine.Events.UnityAction>(false);
