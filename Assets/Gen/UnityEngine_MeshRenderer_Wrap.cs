...
{
    public static class UnityEngine_MeshRenderer_Wrap
    {
        ...
        private static void G_additionalVertexStreams(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.MeshRenderer;
                var result = obj.additionalVertexStreams;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_subMeshStartIndex(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.MeshRenderer;
                var result = obj.subMeshStartIndex;
